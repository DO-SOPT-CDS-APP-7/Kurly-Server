...
public class CartController {
   ...
   @Operation( summary = "장바구니 추가",
            ...
            parameters = {@Parameter(name="productId", description = "상품 ID", in = ParameterIn.DEFAULT, schema = @Schema(defaultValue = "1")),
                          ...
                          @Parameter(name="CUSTOM-AUTH-ID", description = "사용자 ID", in = ParameterIn.HEADER, schema = @Schema(defaultValue = "1"))})
    @PostMapping
   ...
   @Operation( summary = "장바구니 조회",
            ...
            parameters = {@Parameter(name="CUSTOM-AUTH-ID", description = "장바구니 ID", in = ParameterIn.HEADER, schema = @Schema(defaultValue = "1"))})
