...
public class QCartItem extends EntityPathBase<CartItem> {
    ...
    private static final long serialVersionUID = 1765694965L;
    ...
    public final org.dosopt.www.marketkurly.domain.Product.entity.QProduct product;
    ...
    public QCartItem(Class<? extends CartItem> type, PathMetadata metadata, PathInits inits) {
        ...
        this.product = inits.isInitialized("product") ? new org.dosopt.www.marketkurly.domain.Product.entity.QProduct(forProperty("product"), inits.get("product")) : null;
    }
